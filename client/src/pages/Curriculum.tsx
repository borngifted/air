    ...
    <PublicShell>
      <section className="page-hero">
        <div className="container py-20 sm:py-28">
          <p className="eyebrow">Lessons · members · four moves</p>
          ...
          <p className="mt-8 max-w-2xl text-lg leading-8 text-mist">Each move has three short video lessons. Clear: know what you want. Direct: explain it clearly to AI. Judge: check what AI got right or wrong. Make: improve and complete the result. Every lesson has an Explore, Create, and Build level inside it.</p>
          <div className="mt-8 max-w-2xl rounded-2xl border border-white/15 bg-white/5 p-5 text-sm leading-7 text-mist">These lessons are the four moves from AiR: Flow With AI, practiced first in the Prompt Relay and then carried into personal life, school, and future careers. <Link href="/class" className="font-bold text-white underline underline-offset-4">See the one-hour class</Link></div>
        </div>
      </section>
