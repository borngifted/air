...
// The full program page (/program) tells the Flow With AI story in the order the class runs.
// The home page stays minimal on purpose; this is where the concept is laid out:
